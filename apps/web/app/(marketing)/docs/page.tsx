      ...
      <section className="mk-section" id="pipeline">
        ...
        <div className="doc-steps">
          <div className="doc-step glass">
            ...
            <div><h3>Intake</h3><p style={{ color: "var(--muted)" }}>A migration request enters the system — from a developer's plain-English description, a PR diff, or direct SQL.</p></div>
          </div>
          <div className="doc-step glass">
            <div className="doc-step-num">2</div>
            <div><h3>Generate</h3><p style={{ color: "var(--muted)" }}>The agent writes a safe up/down migration pair. For dangerous patterns (SET NOT NULL with existing NULLs), it generates a two-phase approach.</p></div>
          </div>
          <div className="doc-step glass">
